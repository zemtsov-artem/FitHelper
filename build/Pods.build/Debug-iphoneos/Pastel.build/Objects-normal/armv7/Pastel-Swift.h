...
typedef SWIFT_ENUM(NSInteger, PastelGradient) {
...
enum PastelPoint : NSInteger;
@class NSCoder;
@class UIColor;

SWIFT_CLASS("_TtC6Pastel10PastelView")
@interface PastelView : UIView
@property (nonatomic) CGPoint startPoint;
@property (nonatomic) CGPoint endPoint;
@property (nonatomic) enum PastelPoint startPastelPoint;
@property (nonatomic) enum PastelPoint endPastelPoint;
...
- (void)layoutSubviews;
- (void)startAnimation;
- (void)setColors:(NSArray<UIColor *> * _Nonnull)colors;
- (void)setPastelGradient:(enum PastelGradient)gradient;
- (void)addcolor:(UIColor * _Nonnull)color;
- (void)removeFromSuperview;
@end

typedef SWIFT_ENUM(NSInteger, PastelPoint) {
  PastelPointLeft = 0,
  PastelPointTop = 1,
  PastelPointRight = 2,
  PastelPointBottom = 3,
...
@interface PastelView (SWIFT_EXTENSION(Pastel)) <CAAnimationDelegate>
