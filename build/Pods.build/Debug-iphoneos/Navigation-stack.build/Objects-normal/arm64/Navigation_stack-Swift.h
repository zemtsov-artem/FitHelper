...
SWIFT_CLASS("_TtC16Navigation_stack15NavigationStack")
@interface NavigationStack : UINavigationController
...
@property (nonatomic, weak) id <UINavigationControllerDelegate> _Nullable stackDelegate;
...
@interface NavigationStack (SWIFT_EXTENSION(Navigation_stack))
...
@interface NavigationStack (SWIFT_EXTENSION(Navigation_stack)) <UINavigationControllerDelegate>
...
@interface UIView (SWIFT_EXTENSION(Navigation_stack))
@end
