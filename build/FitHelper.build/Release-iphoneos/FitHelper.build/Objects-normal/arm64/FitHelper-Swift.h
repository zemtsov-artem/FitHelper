...
@property (nonatomic, strong) Training * _Null_unspecified currentTraining;
@property (nonatomic, strong) UIPickerView * _Nullable datePickerView;
@property (nonatomic, strong) UIPickerView * _Nullable trainingTypePickerView;
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull dayPickOption;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull trainingTypePickOption;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView * _Nonnull)pickerView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)pickerView:(UIPickerView * _Nonnull)pickerView numberOfRowsInComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
