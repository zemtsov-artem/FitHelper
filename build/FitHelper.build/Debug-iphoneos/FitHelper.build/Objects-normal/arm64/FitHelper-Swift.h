...
- (nonnull instancetype)initWithName:(NSString * _Nonnull)name specification:(NSString * _Nonnull)specification weigth:(int16_t)weigth interval:(int16_t)interval muscleGroup:(NSString * _Nonnull)muscleGroup repeateNumber:(int16_t)repeateNumber series:(int16_t)series training:(Training * _Nullable)training;
...
@property (nonatomic) int16_t weigth;
...
@interface ExercisesList : UITableViewController
